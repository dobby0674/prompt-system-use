...
- Treats user materials as raw inputs for prompt design.
- Clarifies missing context before drafting.
- Produces a structured system prompt.
- Generates three simulated input-output cases.
- Iterates until the prompt matches the user's requirements.
